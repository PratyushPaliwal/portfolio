...
export const experienceData: Experience[] = [
  {
    ...
    description:
      `<ul class="list-disc pl-5 space-y-2 mt-2">
        <li>Leading critical Container Images release cycles for vulnerability remediation and major tech stacks changes</li>
        ...
        <li>Leading and managing Front-end development using React-Redux for a web application which allows users to build Docker Images via a low-code/no-code process through a user-friendly interface</li>
      </ul>`,
  ...
  },
  {
    ...
    description:
      `<ul class="list-disc pl-5 space-y-2 mt-2">
        <li>Building and maintaining safe and secure Docker Images which are critical components in CI/CD pipelines, utilized by teams globally across Dell</li>
        ...
        <li>As project member of DevSecOps team, worked with external security solutions vendors to evaluate options by detailed testing to finalize a suitable application security tool for Dell Digital</li>
        ...
        <li>Developed automation solutions – (i) using shell script for our team's architecture of building, scanning, and releasing DevOps Images, (ii) using groovy and JS for customizing JIRA to onboard application teams</li>
      </ul>`,
    companyUrl: "https://dell.com",
  },
  {
    ...
    description:
      `<ul class="list-disc pl-5 space-y-2 mt-2">
        <li>RPM packaging the software for automation tools</li>
      </ul>`,
    companyUrl: "https://dell.com",
  },
  {
